...
% Defining the data
load data_Pab235264.txt
Depth = data_Pab235264(:,1)
Vsh = data_Pab235264(:,2)
Vp = data_Pab235264(:,3)
RHOB = data_Pab235264(:,4)
PHIT = data_Pab235264(:,5)
PHIE = data_Pab235264(:,6)
...
ylabel('Vp (km/s)')
xlabel('Porosity (%)')
title('Vp vs porosity for Pab Sandstone Dhodak-03 (2352-2364m)') 
hold on
plot(PHIT, VpR,'-b')
hold on
plot(PHIT,VpD,'-m')
...
xlabel('Vp (km/s)')
ylabel('Density (g/cc)')
title('Density vs Vp for Pab Sandstone Dhodak-03 (2352-2364m)') 
hold on
plot(Vp,Rho1,'-b')
hold on
plot(Vp,Rho2,'-r')
